...
public class Grid {
    ...
    public void ohrmLogin() throws InterruptedException, MalformedURLException {
        ...
        WebDriver driver = new RemoteWebDriver(new URL("http://192.168.1.4:7598"), caps);
      ...
      //Call getScreenshotAs method to create image file
            ...
            FileHandler.copy(src, new File("C:\\Users\\NaveenKumarKollimarl\\OneDrive - Hallmark Health Care Solutions, Inc\\Desktop\\Selenium  Web\\screenshots.jpg"));
        }
